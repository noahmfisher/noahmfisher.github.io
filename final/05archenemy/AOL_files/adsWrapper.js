var adsHt="https://web.archive.org/web/20031130133734/http://ar.atwola.com/",adsD=new Date(),adsTz="&TZ="+adsD.getTimezoneOffset(),adsScr=adsD.getTime()%0x3fffffff,adsTar='_top',adsExt='aol',adsTp='',adsSL="<SCRIPT LANGUAGE='JavaScript' SRC='"
var adsDel=0,adsOld=1,adsNMSG,adsNG,adsNM,adsSr="",adsOt='',adsScat,adsIP=" SCROLLING=NO FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0></IFRAME>"
...
if (fS!=-1){if (ds.substring(fS+6,fS+7)>=5){dF='F'}}
...
fS=ds.indexOf(f)
fN=nm.indexOf(f)
if (fS!=-1){if (ds.substring(fS+6,fS+7)>=5){dF='F'}else if (fN!=-1){if (nm.substring(fN+6,fN+7)>=5){dF='F'}}}
...
var p1=adsTz+adsScS+adsSr+adsOt,i1=adsI1+adsHt+"/image/"+m+adsI2+adsExt+"?"+p1+"'"+p+adsI3,j
...
j=c+adsCN
if (((t=='c'&&((adsN6&&adsUA.indexOf('rv:0')!=-1)||ie4||(adsAVA.indexOf('MSIE 5.0')!=-1))))||(ie4&&t=='d')||adsN4){adsTp='J',t=''}
...
if (!adsDel){d.write(x+s+"I"+p+adsIP)}else{d.write(x+"''"+p+adsIP)
...
var s=adsHt+"/image/"+m+adsI2+adsExt+"?"+adsTz+adsScS+adsSr+adsOt,p=" HEIGHT="+h+" WIDTH="+w+adsI3,d=document
...
/*
     FILE ARCHIVED ON 13:37:34 Nov 30, 2003 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  RedisCDXSource: 12.159
  LoadShardBlock: 307.154 (3)
  PetaboxLoader3.resolve: 117.044 (2)
  captures_list: 1034.56
  exclusion.robots.policy: 0.155
  esindex: 0.013
  CDXLines.iter: 70.388 (3)
  PetaboxLoader3.datanode: 94.689 (4)
  load_resource: 151.659
